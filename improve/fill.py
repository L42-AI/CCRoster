...
class Greedy(Fill):
    ...
    @staticmethod
    def greedy_fill(Schedule: Schedule) -> Schedule:
        ...
        while filled < len(Schedule):
            ...
            Greedy.compute_priority(Schedule, weeknum)
            Greedy.update_highest_priority_list()
    ...
    @staticmethod
    def compute_priority(Schedule: Schedule, weeknum: int) -> None:
    ...
    @staticmethod
    def update_highest_priority_list() -> None:

...
def fill():
    ...
    mycursor = db.cursor()
    mycursor.execute("CREATE TABLE Employee (name VARCHAR(50), hourly SMALLINT, level SMALLINT, i0d INT PRIMARY KEY AUTO_INCREMENT)")
    ...
    mycursor.execute("DESCRIBE Employee") # hiermee haal je info op uit je db, en zet
    for x in mycursor:
        print(x)

...
class Greedy(Fill):
    ...
    @staticmethod
    def update_availabilty(Schedule: AbsSchedule, employee_id: int, shift_id: int, added: bool, max_hit: bool = False) -> None:
    ...
    @staticmethod
    def set_shift_occupation(Schedule: AbsSchedule, shift_id: int, occupied: bool) -> None:
        if occupied:
    ...
    @staticmethod
    def greedy_fill(employee_list: list[Employee], shift_list: list[Shift], Schedule: AbsSchedule) -> AbsSchedule:
    ...
    @staticmethod
    def compute_priority(employee_list: list[Employee], Schedule: AbsSchedule, weeknum: int) -> None:
